    ...
    const requestBody = {
        contents: [{
            parts: [{ 
                ...
                - Jika pertanyaannya sudah tidak terkait maka jawab dengan pengetahuanmu sebagai gemini ai yang tahu segalanya tentunya dengan senang hati juga dan dengan bahasa yang seperti tadi.
                Pertanyaan: ${message}`
            }]
        }]
    };
